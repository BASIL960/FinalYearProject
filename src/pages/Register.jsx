...
const Register = ({ isDarkMode }) => {
  // Common Fields (User Class)
  const [username, setUsername] = useState(''); // 1. إضافة State لاسم المستخدم
  ...
  const handleSubmit = (e) => {
    ...
    // 2. تحديث تجميع البيانات ليشمل اسم المستخدم
    ...
    <div className={`flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8`}>
      ...
      <div className={`mt-10 sm:mx-auto sm:w-full sm:max-w-sm p-8 rounded-xl shadow-lg border ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'}`}>
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          {/* 3. إضافة حقل User Name قبل الإيميل */}
          <div>
          ...
          {/* --- User Type Selector (After Password) --- */}
          <div>
